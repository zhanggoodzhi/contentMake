...
<template>
  <div>
    ...
    >
      <div
        v-if="option.templateData.TemplateAreaViewModels[option.pageIndex].SmallIndex==1"
        class="content-setting"
      >
        <h5 class="chapter">{{`【第${option.templateData.TemplateAreaViewModels[option.pageIndex].SmallIndex==1?'一':'二'}部分】`}}</h5>
        ...
        <div class="form-item clearfix">
          ...
          <div class="right">
            <!-- <InputNumber
              ...
              @on-change="changeContentScore($event,0)"
            ></InputNumber> -->
            <TipInputNumber
              class="score-inputnumber vm input"
              :value="option.templateData.TemplateAreaViewModels[option.pageIndex].TemplateQuestionViewModels[option.questionIndex].TemplateContentViewModels[0].Score"
