      ...
      <div class="content-setting">
        ...
        <div class="contents">
          <p class="font14"><span>小题设置</span>
            <span class="ml hide">选项</span><span class="mll">分值
             <Poptip  v-if="$route.params.type!=='preview'&&$route.params.type!=='prop'&&$route.params.type!=='lock'" trigger="hover"  content="解锁后，可设置不同分值" placement="bottom">
                <i
                  v-show="$route.params.type!=='preview'"
