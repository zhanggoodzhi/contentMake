        ...
        <div class="area-body">
          ...
          <div v-for="question in paperArea.PaperQuestionViewModels">
            ...
            <div class="operate-bar">
              ...
              <div class="paper-direct-des">{{question.PromptOfPaper}}</div>
              <span
            ...
            <div class="content-body">
              <div v-for="areaContent in question.PaperContentViewModels">
                ...
                <div class="question-title">{{areaContent.Idx}}.{{areaContent.Text}}
...
export default {
  created() {
    console.log(
      "paperArea.PaperQuestionViewModels==",
      this.paperArea.PaperQuestionViewModels
    );
  },
  computed: {
